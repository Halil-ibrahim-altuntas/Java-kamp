...
public class Main {
	...
	public static void main(String[] args) {
		...
		student.setId("1");
		student.setFirstName("Halil İbrahim");
		student.setLastName("Altuntaş");
		student.setEmail("my@gmail.com");	
		student.setPassword("mypassword");
		System.out.println(student.getId()+" id'li öğrenci adı ve soyadı: "+student.getFirstName()+" "+student.getLastName()+","+
				"Bu öğrencinin mail adresi "+student.getEmail());
